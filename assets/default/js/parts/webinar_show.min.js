(function ($) {
  ...
  $('body').on('click', '.js-course-add-to-cart-btn', function (e) {
    ...
    // بعد إرسال النموذج، تحويل المستخدم إلى رابط العربة
    setTimeout(function() {
        window.location.href = '/public/cart';  // هذا هو الرابط الذي سيتم توجيه المستخدم إليه بعد إضافة المنتج
    }, 1000);  // تأخير لمدة ثانية واحدة للسماح بعملية الإضافة
});
