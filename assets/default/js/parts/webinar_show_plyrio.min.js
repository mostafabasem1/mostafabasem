(function ($) {
  ...
  // --- بداية التعديل: إضافة كود CSS للحماية المحسّن ---
  var protectionStyleId = 'plyr-protection-style';
  if (!document.getElementById(protectionStyleId)) {
      var styles = `
          .overlay-protection {
              position: absolute;
              top: 0;
              ...
              height: 100%;
              z-index: 1;
              pointer-events: none; /* تجاهل جميع النقرات على الطبقة نفسها */
          }
          
          /* السماح بالتفاعل مع أزرار Plyr */
          .plyr__controls,
          .plyr__control,
          .plyr__volume,
          .plyr__progress,
          ...
          .plyr__control--overlaid {
              pointer-events: auto !important; /* تفعيل النقرات على الأزرار */
          ...
          /* حماية iframe اليوتيوب/فيميو من النقر المباشر */
          .plyr__video-wrapper iframe {
              pointer-events: none !important;
          }
      `;
      var styleSheet = document.createElement("style");
      styleSheet.id = protectionStyleId;
  ...
  $('body').on('click', '#webinarDemoVideoBtn', function (e) {
    ...
    var modalHtml = `
        <div id="webinarDemoVideoModal" class="demo-video-modal">
            ...
            <div class="demo-video-card mt-25" style="position: relative;">
                ${playerHtml}
